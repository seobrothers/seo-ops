...
declare module '$env/static/private' {
	...
	export const PRODUCTION_DATABASE_URL: string;
	export const PRODUCTION_SUPABASE_URL: string;
	export const PRODUCTION_SUPABASE_ANON_KEY: string;
	export const NODE_ENV: string;
	export const KINDE_CLIENT_ID: string;
	export const KINDE_CLIENT_SECRET: string;
	export const KINDE_ISSUER_URL: string;
	export const KINDE_SITE_URL: string;
